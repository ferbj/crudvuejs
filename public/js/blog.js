        ...
        methods:{
            ...
            createItem: function(){
                ...
                this.$http.post('/vueitems',input).then((response) => {
                    ...
                    toastr.success('Post Creado Satisfactoriamente','Success Alert',{timeOut: 5000});
                }, (response) => {
            ...
            deleteItem: function(item){
                this.$http.delete('/vueitems/'+item.id).then((response) => {
                    this.changePage(this.pagination.current_page);
                    toastr.error('Post Eliminado Satisfactoriamente','Danger Alert',{timeOut: 5000});
                });
            },
            ...
            updateItem: function(id){
                ...
                this.$http.put('/vueitems/'+id,input).then((response) => {
                    ...
                    toastr.warning('Post Actualizado Satisfactoriamente','Warning Alert',{timeOut: 5000});
                 }, (response) => {
                    this.formErrors = response.data;
                });
            },
